...
27.6-million-row response analyzer. MetaPhlAn 4 recovery is always divided by
the genome-equivalent expected abundance. Do not regenerate an uncorrected
read-proportional version for the talk.
...
input/output checksum manifest, `DEVELOPMENT_ONLY.txt`, and `SUCCESS`. Review
the plots visually before putting them in a presentation.
